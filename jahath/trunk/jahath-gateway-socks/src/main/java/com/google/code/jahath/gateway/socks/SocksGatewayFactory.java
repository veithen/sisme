...
public class SocksGatewayFactory extends SimpleManagedServiceFactory {
    public SocksGatewayFactory(BundleContext bundleContext) {
        super(bundleContext);
    }
    ...
    protected void configure(Instance instance, Dictionary properties) throws ConfigurationException {
        ...
        final SocksGateway gateway = new SocksGateway(bundleContext, endpoint);
        instance.registerService(Gateway.class.getName(), gateway, serviceProps);
