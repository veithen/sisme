...
public class HttpOutMessageImpl extends HttpMessage implements HttpOutMessage {
    private final HttpOutputStream request;
    private final HttpHeadersProvider headersProvider;

    public HttpOutMessageImpl(HttpOutputStream request, HttpHeadersProvider headersProvider) {
