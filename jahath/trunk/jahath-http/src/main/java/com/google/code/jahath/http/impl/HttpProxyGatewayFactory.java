...
public class HttpProxyGatewayFactory extends SimpleManagedServiceFactory {
    public HttpProxyGatewayFactory(BundleContext bundleContext) {
        super(bundleContext);
    }
    ...
    protected void configure(Instance instance, Dictionary properties) throws ConfigurationException {
        ...
        final HttpProxyGateway service = new HttpProxyGateway(bundleContext, endpoint);
