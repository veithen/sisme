...
public class DirectHttpGatewayFactory extends SimpleManagedServiceFactory {
    public DirectHttpGatewayFactory(BundleContext bundleContext) {
        super(bundleContext);
    }
    ...
    protected void configure(Instance instance, Dictionary properties) throws ConfigurationException {
        ...
        final DirectHttpGateway service = new DirectHttpGateway(bundleContext, gateway);
        instance.registerService(HttpGateway.class.getName(), service, serviceProps);
